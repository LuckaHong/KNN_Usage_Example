...
train = open(r"C:\Users\mrfre\Desktop\Cours ESILV\Datascience & IA\Projet_knn\train.csv","r")
M = train.readlines()
val_train = []
...
test = open(r"C:\Users\mrfre\Desktop\Cours ESILV\Datascience & IA\Projet_knn\test.csv","r")
N = test.readlines()
val_test = []
...
#%%
envoi = open(r"C:\Users\mrfre\Desktop\Cours ESILV\Datascience & IA\Projet_knn\envoi.csv","w")
